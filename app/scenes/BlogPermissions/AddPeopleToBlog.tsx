...
@observer
class AddPeopleToBlog extends React.Component<Props> {
  @observable
  ...
  handleAddUser = (user: User) => {
    ...
    try {
      ...
      this.props.toasts.showToast(
        t("{{ userName }} was added to the blog", {
          userName: user.name,
        }),
        {
          type: "success",
  ...
  render() {
    const { users, blog, auth, t } = this.props;
    ...
    return (
      <Flex column>
        ...
        <PaginatedList
          ...
          items={users.notInBlog(blog.id, this.query)}
...
export default withTranslation()(withStores(AddPeopleToBlog));
