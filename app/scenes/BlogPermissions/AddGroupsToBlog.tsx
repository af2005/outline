...
@observer
class AddGroupsToBlog extends React.Component<Props> {
  @observable
  ...
  handleAddGroup = (group: Group) => {
    ...
    try {
      this.props.blogGroupMemberships.create({
        blogId: this.props.blog.id,
        groupId: group.id,
        permission: "read_write",
      });
      this.props.toasts.showToast(
        t("{{ groupName }} was added to the blog", {
  ...
  render() {
    const { groups, policies, blog, auth, t } = this.props;
    ...
    return (
      <Flex column>
        ...
        <PaginatedList
          ...
          items={groups.notInBlog(blog.id, this.query)}
...
export default withTranslation()(withStores(AddGroupsToBlog));
